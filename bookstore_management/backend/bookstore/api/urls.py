...
urlpatterns = [
    # path('books/', views.BookListView.as_view()), # get, post request handle korbe #API VIEW
    # path('books/<int:pk>/', views.BookListUpdateDelete.as_view()), # update, delete request handle korbe  #API VIEW
